  ...
  return (
    <section>
      ...
      <p className="text-lg leading-relaxed mb-4">
        Currently a software engineer at Square SF, I graduated from UC San
        Diego with a B.S. in Computer Science (March 2018). Previously interned
        at Square, Google and Microsoft.
      </p>
      <p className="text-lg leading-relaxed mb-4">
